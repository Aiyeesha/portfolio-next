    ...
    <div className="grid items-center gap-10 lg:grid-cols-[140px_1fr]">
      ...
      <div>
        <h1 className="text-5xl font-semibold leading-tight">
          {track === "salesforce" ? t("hero.title_salesforce") : t("hero.title_itops")} <span className="text-cyan-300">{track === "salesforce" ? t("hero.subtitle_salesforce") : t("hero.subtitle_itops")}</span>
        </h1>
