    ...
    return [
      {
        ...
        content: (
          <ul className="list-disc space-y-2 pl-5">
            <li>
              Conception et mise en œuvre de solutions Salesforce avancées en collaboration avec les
              équipes métier.
            </li>
            <li>
            ...
            <li>
              Supervision des bonnes pratiques de développement : CI/CD, revues de code et gestion
              des performances.
            </li>
            <li>
              Accompagnement et formation des collègues et apprenants sur les outils et méthodes
              Salesforce.
            </li>
            <li>
      ...
      },
      {
        ...
        content: (
          <ul className="list-disc space-y-2 pl-5">
            <li>
              Développement et maintenance de 10+ classes Apex et batchs pour automatiser le
              traitement de données et le reporting.
            </li>
            <li>
            ...
            <li>
              Conception de composants réutilisables via Lightning App Builder et Lightning Web
              Components.
            </li>
            <li>
            ...
            <li>
              Support migrations de données (CSV / assistants d’import), avec contrôle qualité et
      ...
      },
      {
        ...
        content: (
          <ul className="list-disc space-y-2 pl-5">
            ...
            <li>Installation et maintenance de logiciels (Blancco, Acronis, Datto RMM).</li>
            <li>
              Supervision de l’infrastructure réseau et réponse à des incidents de sécurité, dont
              des exercices de type ransomware.
            </li>
            <li>
              Rédaction de procédures et contribution à une base de connaissances sur les incidents
              récurrents.
            </li>
          </ul>
        ),
  ...
  return [
    ...
    },
    {
      ...
      content: (
        <ul className="list-disc space-y-2 pl-5">
          <li>
            Built and maintained 10+ Apex classes and batch jobs to automate data processing and
            reporting.
          </li>
          <li>
          ...
          <li>
            Implemented CI/CD practices with Salesforce CLI and Git to streamline deployments across
            sandboxes.
          </li>
          <li>
    ...
    return [
      {
        ...
        content: (
          <ul className="list-disc space-y-2 pl-5">
            ...
            <li>
              Titre pro Technicien(ne) Supérieur(e) Systèmes & Réseaux — GRETA du Val d’Oise (Oct.
              2022 – Juin 2023)
            </li>
  ...
  return [
    {
      ...
      content: (
        <ul className="list-disc space-y-2 pl-5">
          ...
          <li>
            Higher Technician in Systems & Networks — GRETA du Val d’Oise (Oct 2022 – Jun 2023)
          </li>
