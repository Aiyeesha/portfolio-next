...
4. Vérifiez que l’email reçu a bien généré un ticket :
   ...
   - Pièces jointes → onglet _Attachments_

**Bonnes pratiques**

- Une adresse unique : `support@...`
- Un objet email explicite : `[Client] - [Service] - [Symptôme]`
- Un champ _Company / Contact_ correctement mappé (sinon le faire dès la qualification).
...
- Impact _élevé_ + Urgence _élevée_ → **P1**
- Impact _élevé_ + Urgence _moyenne_ → **P2**
- Impact _moyen_ + Urgence _élevée_ → **P2**
- Impact _moyen_ + Urgence _moyenne_ → **P3**
- Tout le reste → **P4**
